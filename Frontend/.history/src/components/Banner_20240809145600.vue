<template>
    <div class="w-full">
        <vueper-slides :autoplay="3000" :progress="true" :visible-slides="1">
            <vueper-slide v-for="(slide, i) in slides" :key="i">
                <!-- Navbar -->
                <nav class="bg-white shadow-lg">
                    <div
                        class="md:flex items-center justify-between py-2 px-8 md:px-12"
                    >
                ...
                <div class="flex bg-white" style="height: 600px">
                    ...
                    >
                        <div>
                            ...
                            <div
                                class="flex justify-center lg:justify-start mt-6"
                            >
                                <a
...
const slides = [
    ...
    },
    {
        image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1352&q=80",
        title: "Idea #2",
        content: "Blanditiis commodi cum cupiditate ducimus, fugit harum.",
    },
    {
        image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1352&q=80",
        title: "Idea #3",
        content: "Necessitatibus odio quam quasi, quibusdam rem tempora.",
    },
];
</script>
